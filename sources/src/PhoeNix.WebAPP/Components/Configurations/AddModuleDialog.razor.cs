...
using UpdateSharedRequest = PhoeNix.WebAPP.ApiClient.Contracts.UpdateConfigurationModuleRequest;
using UpdateSystemRequest = PhoeNix.WebAPP.ApiClient.Contracts.UpdateConfigurationSystemModuleRequest;
