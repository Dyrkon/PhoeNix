...
namespace PhoeNix.Persistence.Migrations
{
    ...
    [Migration("20260711140434_AddGitSyncSettings")]
    partial class AddGitSyncSettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PhoeNix.Domain.Entities.AppSettings.AppSettings", b =>
                {
                    ...
                    b.Property<int>("GitAuthMethod")
                        .HasColumnType("integer");

                    b.Property<string>("GitAuthSecret")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("GitPullDeleteOrphans")
                        .HasColumnType("boolean");

                    b.Property<int?>("GitPullPollingIntervalMinutes")
                        .HasColumnType("integer");

                    b.Property<bool>("GitPushNixFiles")
                        .HasColumnType("boolean");

                    b.Property<int>("GitPushValidationTier")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PhoeNix.Domain.Entities.Systems.System", b =>
                {
                    ...
                    b.HasIndex("ConfigurationId", "Name")
                        .IsUnique();
